...
- truncate will find all the files before the given position that cen be deleted, start_record_id_ will be incremented to the position before the files will be delted.
