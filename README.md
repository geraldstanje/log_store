...
- truncate will find all the files before the given position that are fully of completely deletable data, start_record_id_ will be incremented to the position
